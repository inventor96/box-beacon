...
<p>If this was in fact you that made the request, head over to <a href="{{route:'auth:reset', ['token' => $token]}}" target="_blank">{{route:'auth:reset', ['token' => $token]}}</a> to reset your password.</p>
